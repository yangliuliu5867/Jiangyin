...
namespace ros_interface {
    ...
    using PositionCommandPubPtr = rclcpp::Publisher<mars_super_msgs::msg::PositionCommand>::SharedPtr;
    using PolynomialTrajectoryPubPtr = rclcpp::Publisher<mars_super_msgs::msg::PolynomialTrajectory>::SharedPtr;
