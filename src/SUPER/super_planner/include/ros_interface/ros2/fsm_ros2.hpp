...
#include "mars_super_msgs/msg/polynomial_trajectory.hpp"
...
namespace fsm {
    class FsmRos2 : public Fsm {
        ...
        rclcpp::Publisher<mars_super_msgs::msg::PositionCommand>::SharedPtr cmd_pub_;
        rclcpp::Publisher<mars_super_msgs::msg::PolynomialTrajectory>::SharedPtr mpc_cmd_pub_;
        ...
        mars_super_msgs::msg::PositionCommand pid_cmd_;
        rog_map::ROGMapROS::Ptr map_ptr_;
        mars_super_msgs::msg::PositionCommand latest_cmd;
        nav_msgs::msg::Path path;

        vector<mars_super_msgs::msg::PositionCommand> cmd_logs_;
        ...
        void publishPolyTraj() override {
            mars_super_msgs::msg::PolynomialTrajectory cmd_traj;
            getCommittedTrajectory(cmd_traj);
            mpc_cmd_pub_->publish(cmd_traj);
        }

        void getOneHeartBeatMsg(mars_super_msgs::msg::PolynomialTrajectory &heartbeat, bool &traj_finish) {
            heartbeat.type = mars_super_msgs::msg::PolynomialTrajectory::HEART_BEAT;
        ...
        void getCommittedTrajectory(mars_super_msgs::msg::PolynomialTrajectory &cmd_traj) {
            ros_ptr_->getSimTime(cmd_traj.header.stamp.sec, cmd_traj.header.stamp.nanosec);
            cmd_traj.header.frame_id = "world";
            cmd_traj.type = mars_super_msgs::msg::PolynomialTrajectory::POSITION_TRAJ |
                            mars_super_msgs::msg::PolynomialTrajectory::HEART_BEAT;
            ...
            if (!yaw_traj.empty()) {
                cmd_traj.type = cmd_traj.type |
                                mars_super_msgs::msg::PolynomialTrajectory::YAW_TRAJ;
        ...
        void getOnePositionCommand(mars_super_msgs::msg::PositionCommand &pos_cmd, bool &traj_finish) {
...
//            ros_ptr_->getSimTime(pos_cmd.header.stamp.sec, pos_cmd.header.stamp.nanosec);
    ...
    public:
        ...
        void init(const rclcpp::Node::SharedPtr nh, const std::string &cfg_path) {
            ...
            cmd_pub_ = nh_->create_publisher<mars_super_msgs::msg::PositionCommand>(cfg_.cmd_topic, qos);
            mpc_cmd_pub_ = nh_->create_publisher<mars_super_msgs::msg::PolynomialTrajectory>(cfg_.mpc_cmd_topic,
                                                                                                 qos);
            path_pub_ = nh_->create_publisher<nav_msgs::msg::Path>("fsm/path", qos);

            int cmd_cnt = 0;

            if (cfg_.click_goal_en||cfg_.goal_topic_en) {
        ...
        void pubCmdTimerCallback() {
            ...
            mars_super_msgs::msg::PolynomialTrajectory heartbeat;
