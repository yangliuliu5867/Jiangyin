...
namespace super_planner {
    ...
    public:
        ...
        int nmpc_horizon{};
        double nmpc_step;
        double max_vel0,max_vel1,max_vel2;
        /*LYX*/
        ...
        Config(const std::string & cfg_path) {
            ...
            loader.LoadParam("super_planner/nmpc_horizon", nmpc_horizon, 6);
            loader.LoadParam("super_planner/nmpc_step", nmpc_step, 0.05);

            loader.LoadParam("rog_map/resolution", resolution, 0.01, true);

            /*LYX*/
            loader.LoadParam("super_planner/max_vel0", max_vel0, 1.0);
            loader.LoadParam("super_planner/max_vel1", max_vel1, 2.0);
            loader.LoadParam("super_planner/max_vel2", max_vel2, 3.0);
            /*LYX*/
