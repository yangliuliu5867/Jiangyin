...
public:
  ...
  bool getMappingState() {return mp_.is_mapping;}
...
private:
  ...
  ros::Subscriber indep_cloud_sub_, indep_odom_sub_, extrinsic_sub_, flag_sub_,ego_flag_state_sub;
