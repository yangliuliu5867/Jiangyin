...
namespace ego_planner
{
      ...
      int id_cps_end, PtsChk_t &pts_check)
  {
    ...
    ROS_INFO("T,%f, POLY V, %f",t_step,max_vel_);
  ...
  void PolyTrajOptimizer::setVelocity(double _max_vel_) {max_vel_=_max_vel_;}
  double PolyTrajOptimizer::getVelocity() {return max_vel_;}
} // namespace ego_planner